...
--
-- Name: elements unik_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unik_name UNIQUE (name);


--
-- Name: elements unik_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unik_symbol UNIQUE (symbol);


--
-- Name: properties fk_atomicnum; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomicnum FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
